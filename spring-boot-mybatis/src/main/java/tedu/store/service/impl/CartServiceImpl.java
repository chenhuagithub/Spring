...
public class CartServiceImpl implements ICartService {
    ...
    @Override
    public List<CartVO> getByUid(Integer uid, Integer pag, Integer num) {
        return findByUid(uid, pag, num);
    }

    @Override
    public List<CartVO> getByTitle(Integer uid, String title, Integer pag, Integer num) {
        return findByTitle(uid, title, pag, num);
    }
     ...
     * @return 用户的购物车数据列表
     */
    private List<CartVO> findByUid(Integer uid, Integer pag, Integer num) {
        return cartMapper.findByUid(uid, pag, num);
    }

    private List<CartVO> findByTitle(Integer uid, String title, Integer pag, Integer num) {
        return cartMapper.findByTitle(uid, title, pag, num);
    }
